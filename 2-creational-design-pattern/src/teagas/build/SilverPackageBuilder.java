...
class SilverPackageBuilder implements PackageBuilderInterface {

  private HardwareInterface hardware;
  private ServerInterface server;
  
  SilverPackageBuilder() throws Exception {      
    System.out.println("SilverPackageBuilder created");
  }
  ...
  public void setupHardware() throws Exception {
    ...
    MicroInterface micro = MicroFactory.create("ATMega32");
    this.hardware.setMicro(micro);

    WeightSensorInterface weightSensor = WeightSensorFactory.create("LoadSensor");
    ...
    DisplayInterface display = DisplayFactory.create("LCD");
